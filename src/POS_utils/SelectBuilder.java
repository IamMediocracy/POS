...
public class SelectBuilder {
	...
	// class courtesy of John Krasnay
	// http://john.krasnay.ca/2010/02/15/building-sql-in-java.html
	//
	// We looked for a better way to dynamically build our SQL statements and
	// decided that writing a library ourselves would be too time consuming
	// under the constraints of this class and project.
